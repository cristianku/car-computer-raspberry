...
class OBD(object):
    ...
    def __connect(self, portstr, baudrate, protocol):
        ...
        if portstr is None:
            print("Using scan_serial to select port")
            portnames = scan_serial()
            print("Available ports: " + str(portnames))

            if not portnames:
                print("No OBD-II adapters found")
                return
    ...
    def query(self, cmd, force=False):
        ...
        # print " "
        # print " ---- cmd_string " + str(cmd_string)
        # print " "
    ...
    def __build_command_string(self, cmd):
        # print " "
        # print " ---- __build_command_string " + str(cmd)
        # print " "

        #""" assembles the appropriate command string """
        cmd_string = cmd.command
        # print " "
        # print " ---- cmd_string1 " + str(cmd_string)
        # print " "
        ...
        # print " "
        # print " ---- cmd_string2 " + str(cmd_string)
        # print " "

        # if we sent this last time, just send
        # if self.fast and (cmd_string == self.__last_command):
        #     cmd_string = b""
        #     print " f we sent this last time, just send"
        # print " "
        # print " ---- cmd_string3 " + str(cmd_string)
        # print " "
